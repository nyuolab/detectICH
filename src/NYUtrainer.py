...
from torchvision.datasets import CIFAR10 #make modification
...
from simple_network import model_fxn #replace your own model name


class NYUTrainer(Executor):

    def __init__(self, lr=0.001, epochs=12, train_task_name=AppConstants.TASK_TRAIN,
